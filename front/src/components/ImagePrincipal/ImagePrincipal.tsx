...
const ImagePrincipal = () => {
	return (
		<div className=" h-[100vh] bg-cover bg-center bg-[url('/Principal.png')] rounded-2xl  flex-col items-center justify-around flex w-[calc(100%+220px)] relative left-[-110px] max-sm:h-96 ">
			...
			<div className="bg-slate-50 w-[650px] h-24 rounded-2xl flex items-center justify-center max-sm:w-[20rem] max-sm:h-14 max-sm:text-sm">
				<div className="flex  items-center ">
					...
					<input
						...
						className=" mx-4 p-4 rounded-lg w-full max-w-md focus:outline-none focus:ring-2 focus:ring-orange-500  placeholder-black placeholder-opacity-70 placeholder:text-xl placeholder:bg-center text-center max-sm:text-xs max-sm:placeholder:text-sm max-sm:p-2"
					/>
